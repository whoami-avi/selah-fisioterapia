...
const SUPABASE_URL = 'https://jzbrxtcqfwljpizpmemg.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp6YnJ4dGNxZndsanBpenBtZW1nIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE5OTk4MDQsImV4cCI6MjA4NzU3NTgwNH0.9BRClUXMv8-Ougzc5JE2VYXbWmanZ4S8RZNkZNM5U8w';
...
const APP_VERSION_DATE = '2026-02-25';
...
function savePatient(event) {
    ...
    const patientData = {
        ...
        body_zone: document.getElementById('patientBodyZone').value,
        therapy_type: document.getElementById('patientTherapyType').value,
    ...
    if (existingId) {
        updatePatientInSupabase(id, patientData);
    } else {
